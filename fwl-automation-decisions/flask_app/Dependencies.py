...
from infrastructure.flsql.repository.FirewallRepositorySQL import FirewallRepositorySQL
...
class AppModule(Module):
    ...
    def configure(self, binder):
        ...
        firewall_repository = FirewallRepositorySQL(base_repo)
        ...
        binder.bind(FirewallRepository, to=firewall_repository, scope=singleton)
